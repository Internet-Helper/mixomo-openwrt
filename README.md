...
<img width="971" height="609" alt="2" src="https://github.com/user-attachments/assets/122dfd7a-19ce-4fea-8fbe-5f4443f38959" />
...
- Зайдите в OpenWrt — Службы — Mixomo — Нажмите на «Конфигурация» в Mihomo и отредактируйте или создайте свою<br>
  Может помочь [оригинальная документация](https://mihomo-docs.netlify.app/ru/config/) или [онлайн генератор web4core](https://spatiumstas.github.io/web4core)  
